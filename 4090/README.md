...
- **Optimized Multiprocessing**: (Enhanced) Uses staggered worker initialization and adaptive batching to ensure stability on Windows even with 8+ parallel processes.
